...
#### Prompt: recover prior context and start work
...
#### Prompt: resolve scope first, then start
...
#### Prompt: save a continuation handoff before stopping
...
#### Prompt: load recent context without a query
